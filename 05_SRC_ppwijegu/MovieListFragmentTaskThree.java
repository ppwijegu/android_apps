...
public class MovieListFragmentTaskThree extends Fragment{
    private RecyclerView moviesRV;

    MovieAdapterTaskThree mAdapter;
    private List<Map<String,?>> movieData;
    private MovieData allMData=new MovieData();


    public MovieListFragmentTaskThree() {
    ...
    public static MovieListFragmentTaskThree newInstance() {
        MovieListFragmentTaskThree fragment = new MovieListFragmentTaskThree();
...
//
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter= new MovieAdapterTaskThree(rootView.getContext(),movieData);
    ...
    public void onCreateOptionsMenu (Menu menu, MenuInflater inflater) {
        if (menu.findItem(R.id.search)==null) {
            inflater.inflate(R.menu.movie_list_menu_task3, menu);

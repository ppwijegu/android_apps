...
public class MovieData {
	...
	private String[] movieDataHeader= new String[]{ "name","description","year","length","rating","director","stars","url"};
    ...
    public String[] getMovieDataHeaders(){
		return movieDataHeader;
	}
    ...
    public int findFirst(String query){
		...
		for(int i=0;i<moviesList.size();i++){
			...
			String mStrings=((String) movie.get("name")+(" ")+(String) movie.get("description")+" "+
					(String) movie.get("stars")+" "+(String) movie.get("director")).toLowerCase();

			if(mStrings.contains(lowerCaseQuery)){
				return i;
			}

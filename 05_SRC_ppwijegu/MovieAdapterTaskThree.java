...
public class MovieAdapterTaskThree extends RecyclerView.Adapter<MovieAdapterTaskThree.ViewHolder> {
    ...
    public MovieAdapterTaskThree(Context context, List<Map<String,?>> movieData) {
        mdata=movieData;
        sorted=false;
        mContext = context;
    }
...
//                    }
                    int position=getAdapterPosition();
                    AppCompatActivity activity = (MovieListActivityTaskThree) view.getContext();
            ...
            itemView.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View view) {
                    ...
                    MovieListActivityTaskThree activity = (MovieListActivityTaskThree) view.getContext();
                    activity.mToolBarBottom.setVisibility(View.GONE);
                    int position=getAdapterPosition();
                    HashMap movie=(HashMap)mdata.get(position);
